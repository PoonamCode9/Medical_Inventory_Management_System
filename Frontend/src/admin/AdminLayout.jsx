...
const menu = [
  ...
  { label: 'Dashboard', to: '/admin/dashboard', icon: 'chart' },
  {
    label: 'Medicines',
    icon: 'pills',
    items: [
  ...
  { label: 'Suppliers', to: '/admin/suppliers', icon: 'landmark' },
  {
    label: 'Users & Roles',
    to: '/admin/users',
    icon: 'users',
  ...
  { label: 'Tasks', to: '/admin/tasks', icon: 'file' },
  { label: 'Notifications', to: '/admin/notifications', icon: 'bell' },
  { label: 'Alerts', to: '/admin/alerts', icon: 'alert' },
          ...
          <div className="bb-brand">
            ...
            {!collapsed && (
              <div>
                ...
                <div className="bb-brand-sub">Admin Console</div>
              </div>
            )}
          </div>
          ...
          <div className="bb-topbar-right">
            ...
            <div className="bb-profile">
              ...
              <div className="bb-profile-meta">
                <div className="bb-profile-name">Admin</div>
                <div className="bb-profile-role">System Administrator</div>
              </div>
            </div>
