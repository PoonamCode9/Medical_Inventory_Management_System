...
import com.MediStock.app.services.PurchaseOrderServiceImpl;
...
public class PurchaseOrderServiceImpl implements PurchaseOrderService {
    ...
    public PurchaseOrderResponse createPurchaseOrder(PurchaseOrderRequest request) {
        ...
        purchaseOrder.setMedicineId(medicine.getMedicineId());
        ...
        @Override
    public PurchaseOrderResponse updatePurchaseOrder(Long orderId,
    ...
    public PurchaseOrderSummaryResponse getPurchaseOrderSummary() {
        ...
        summary.setPendingOrders(
                (int) orders.stream()
                        .filter(order -> order.getStatus() == PurchaseOrderStatus.PENDING)
                        .count());

        summary.setApprovedOrders(
                (int) orders.stream()
                        .filter(order -> order.getStatus() == PurchaseOrderStatus.APPROVED)
                        .count());
...
summary.setTotalOrderValue(totalValue);

        return summary;
    }

    @Override
    public List<PurchaseOrderResponse> searchBySupplier(Long supplierId) {
    ...
    @Override
public List<PurchaseOrderResponse> searchByStatus(PurchaseOrderStatus status) {
    ...
    private PurchaseOrderResponse mapToResponse(PurchaseOrder purchaseOrder) {
        ...
        Medicine medicine = medicineRepository.findById(purchaseOrder.getMedicineId())
                .orElseThrow(() -> new RuntimeException("Medicine not found"));
