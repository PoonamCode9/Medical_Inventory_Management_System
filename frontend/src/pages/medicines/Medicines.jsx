  ...
  if (loading) {
    return (
      <div className="p-8 text-center text-slate-500 font-medium flex flex-col items-center justify-center min-h-[60vh] gap-3">
        ...
        <p className="text-sm">Loading medicine catalogue...</p>
      </div>
    );
  }
    ...
    <div className="w-full pb-10 min-h-screen bg-slate-50/60">
      ...
      <div className="px-6 space-y-6">
        <div className="flex flex-col sm:flex-row gap-3 bg-white p-4 rounded-2xl border border-slate-200/80 shadow-xs">
          ...
          <select
            className="border border-slate-300 rounded-xl px-3 py-2 text-xs text-slate-700 bg-slate-50/50 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 cursor-pointer"
              ...
              <tbody className="divide-y divide-slate-100">
                {filteredMedicines.length > 0 ? (
                  ...
                  <tr>
                    <td
                      colSpan={
                        role === "Admin" || role === "Pharmacist" ? "7" : "6"
                      }
                    ...
                    >
                      <div className="flex flex-col items-center gap-2">
                        ...
                        <p className="text-xs font-medium text-slate-500">
                          No medicines found. Try adjusting your search filters.
                        </p>
                      </div>
                    </td>
                  </tr>
