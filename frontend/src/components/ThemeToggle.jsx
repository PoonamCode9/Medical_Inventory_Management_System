      ...
      <button
        ...
        className={`flex items-center gap-3 w-full px-3 py-2.5 rounded-xl border transition-all duration-200 ${
          open
            ...
            : 'border-transparent text-slate-400 hover:bg-slate-800/60 hover:text-slate-200 dark:hover:bg-slate-800/60 light:hover:bg-slate-200/60'
        }`}
        title="Change theme"
      >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className={`absolute z-50 glass-card rounded-xl border border-[var(--border-subtle)] shadow-xl p-1.5 min-w-[160px] ${
